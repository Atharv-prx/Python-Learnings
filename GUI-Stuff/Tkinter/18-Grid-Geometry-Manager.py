...
firstNameEntry = Entry(window).grid(row=1,
                                    column=1)
...
lastNameEntry = Entry(window).grid(row=2,
                                   column=1)
...
emailLabel = Label(window,
                   ...
                   bg="blue").grid(row=3,
                                   column=0)
emailEntry = Entry(window).grid(row=3,
                                column=1)

submitButton = Button(window,
                      text="Submit").grid(row=4,
                                          column=0,
                                          columnspan=2) # places widget in between columns
