...
def add_sprinkles(func):
    ...
    def wrapper(*args, **kwargs): # We need args and kwargs here so that it can accept any king of arguments and keyword-arguments if needed
        ...
        return func(*args, **kwargs) # Same explanation as line 7
    return wrapper
...
def add_fudge(func):
    ...
    return wrapper # Return the function itself, if we use return wrapper()--> this would return result of execution 
