...
class Book:
    ...
    def __eq__(self, other):
        return self.title == other.title and self.author == other.title #Return boolean value
    ...
    def __add__(self, other):
        return f"{self.num_pages + other.num_pages} pages" #Adding f-string is completely optional btw
